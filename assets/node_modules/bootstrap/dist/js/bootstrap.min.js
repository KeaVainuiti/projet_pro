...
const notes = document.querySelectorAll('.form_jello> div')

for(var i=0;i<notes.length;i++){

  notes[i].addEventListener('mouseenter',function(e) { 
      const form_jello = e.target.dataset.form_jello;
      e.target.classList.add('animated', 'infinite', form_jello);
    window.setTimeout(function(){
      e.target.classList.remove('animated', 'infinite', form_jello);
    }, 3000);
  });
}
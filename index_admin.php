			...
			<div class="col-md-10">
				<div class="tab-content" id="nav-tabContent">
					...
					<div class="tab-pane fade show active" id="list-home" role="tabpanel" aria-labelledby="list-home-list">
						<div class="row">
							<div class="col-md-6" align="center" style="background-color: #BDC3C7">
								...
								// <!-- ADD NEW COMPAGNIE  -->
									echo '<form  method="POST">';
										...
										echo '<p>';
											echo '<input type="submit" name="btn_compagnie" value="Valider"></input>';
										echo '</p>';
									echo '</form>';
								?>
							</div>
							<div class="col-md-6" align="center" style="background-color: #87B7D0">
								<label style="text-align:center">
											...
											foreach ($resCompagnie as $valeur) { //Boucle : Pour chaque resultat 
												...
												if (($etat == "ouvrir") && ($id_clique == $valeur['id_compagnie'])) {
													...
													echo '<form action="index_admin.php" method="post">';
														echo "<input type='' name='id_compagnie' value=" . $valeur['id_compagnie'] . ">";
														echo "<tr>";
															...
															echo "<td>";
																echo "<input type='submit' name='btn_compagnie' value='Confirmer'></input>";
															echo "</td>";
														echo "<tr>";
													echo '</form>';
													...
													echo "<tr>";
														...
														echo "<td>";
																...
																echo '<form action="index_admin.php" method="post">';
																		...
																		echo "<input type='submit' name='btn_compagnie' value='Modifier'></input>";
																...
																// echo '<form action="index_admin.php" method="post">';
																		...
																		echo "<input type='hidden' name='id_compagnie' value=" . $valeur['id_compagnie'] . ">";
																		echo "<input type='submit' name='btn_compagnie' value='Supprimer'></input>";
																echo '</form>';
						...
						<div class="col-md-6" align="center" style="background-color: #87B7D0">
								...
								<?php
									echo '<form  method="POST">';
										...
										echo '<p>';
											echo '<input type="submit" name="btn_section" value="Valider"></input>';
										echo '</p>';
									echo '</form>';
								?>
							</div>
							<div class="col-md-6" style="background-color: #BDC3C7">
								<label style="text-align:center">
											...
											foreach ($resSection as $valeur) { 
													...
													echo "<tr>";
														...
														echo '<form action="assets/php/form/form_section.php" method="POST">';
															echo "<td>";
																	echo "<input type='submit' name='btn_section' value='Modifier'></input>";
														...
														echo '<form method="POST" action="index_admin.php">';
															echo "<td>";
																	echo "<input type='hidden' name='id_section' value=" . $valeur['id_section'] . ">";
																	echo "<input type='submit' name='btn_section' value='Supprimer'></input>";
															echo "</td>";
														echo '</form>';
													echo "</tr>";
							...
							<div class="col-md-6" align="center" style="background-color:#BDC3C7 ">
								...
								//FORM ADD NEW FILIERE
									echo '<form  method="POST">';
										...
										echo '</p>';
										echo '<p>';
											echo '<input type="submit" name="btn_filiere" value="Valider"></input>';
										echo '</p>';
									echo '</form>';
								?>
							</div>
											...
											foreach ($resFiliere as $valeur) { 
												...
												echo "<tr>";
													...
													echo "<td>";
														...
														echo '<form method="POST" action="index_admin.php">';
															echo "<input type='hidden' name='id_filiere' value=" . $valeur['id_filiere'] . ">";
															echo "<input type='submit' name='btn_filiere' value='Supprimer'></input>";
														echo '</form>';
													echo "</td>";
							...
							<div class="col-md-6" align="center" style="background-color: grey">
								...
								<?php
									echo '<form  method="POST">';
										...
										echo '<p>';
											echo '<input type="submit" name="btn_grade" value="Valider"></input>';
										echo '</p>';
									echo '</form>';
												...
												if (($etatGrade == "ouvrir") && ($id_clique == $valeur['id_grade'])) {
													...
													echo '<form action="index_admin.php" method="post">';
														...
														echo "<tr>";
															...
															echo "<td>";
																echo "<input type='submit' name='btn_grade' value='Confirmer'></input>";
															echo "</td>";
														echo "<tr>";
													echo '</form>';
												} else {
													...
													echo "<tr>";
														...
														echo "<td>";
																...
																echo '<form method="post">';
																		...
																		echo "<input type='submit' name='btn_grade' value='Modifier'></input>";
																		echo "<input type='hidden' name='id_grade' value=" . $valeur['id_grade'] . ">";

																		echo "<input type='hidden' name='name' value=" . $valeur['name'] . ">";
																		echo "<input type='submit' name='btn_grade' value='Supprimer'></input>";											
					...
					<div class="tab-pane fade" id="list-volontaire" role="tabpanel" aria-labelledby="list-volontaire-list">
						<div class="row addVolontaire">
							<div class="col-md-6">
								...
								<div class="container">
									<?php
									// <!-- CREER LES NOUVEAUVEAU VOLONTAIRE  -->
											...
											echo "<tr>";
												...
												echo "<td>";
													echo '<form action="assets/php/form/form_volontaire.php" method="POST">';
														...
														echo "<input type='' name='id_volontaire' value=" . $valeur['id_volontaire'] . ">";
														echo "<input type='' name='firstname' value=" . $valeur['firstname'] . ">";
														echo "<input type='' name='lastname' value=" . $valeur['lastname'] . ">";
														echo "<input type='' name='birthday' value=" . $valeur['birthday'] . ">";
														echo "<input type='' name='phone' value=" . $valeur['phone'] . ">";
														echo "<input type='' name='home' value=" . $valeur['home'] . ">";
														echo "<input type='' name='contact_firstname' value=" . $valeur['contact_firstname'] . ">";
														echo "<input type='' name='contact_lastname' value=" . $valeur['contact_lastname'] . ">";
														echo "<input type='' name='contact_phone' value=" . $valeur['contact_phone'] . ">";
													echo '</form>';
												echo "</td>";
											echo "</tr>";
										}
